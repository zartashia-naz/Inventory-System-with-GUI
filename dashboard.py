...
class IMS:
    def __init__(self, root):
        ...
        lableTitle=Label(self.root,text="INVENTORY MANAGMENT SYSTEM",image=self.logo,compound=LEFT,padx=10,font=("Arial",40,"bold"),bg="purple",fg="white",anchor="w").place(x=0,y=0,relwidth=1,height=70)
